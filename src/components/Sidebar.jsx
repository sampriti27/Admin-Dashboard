...
const Sidebar = () => {
  ...
  const activeLink =
    "flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg bg-light-gray text-md m-2";
  ...
  return (
    <div className="ml-3 h-screen md:overflow-hidden overfow-auto md:hover:overflow-auto pb-10">
      {activeMenu && (
        <>
